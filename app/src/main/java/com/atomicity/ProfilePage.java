...
public class ProfilePage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("user_info"
...
//                    Toast.makeText(getActivity(), R.string.term_condition, Toast.LENGTH_SHORT).show();
//                    return true;
//                case R.id.action_faq:
//                    FragmentTransaction fragmentTransaction2 = getActivity().getSupportFragmentManager().beginTransaction();
//                    FaqFragment selectedFragment = new FaqFragment();
//                    fragmentTransaction2.replace(R.id.fragment_container,selectedFragment);
